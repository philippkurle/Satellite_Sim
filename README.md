...
This project gave me first-hand exposure to topics such as integrating Arduino-based hardware, reading AI-assisted C++ code beyond my original skill level, and debugging a multi-subsystem embedded prototype.
...
- Learned how to identify the row and column structure of the keypad matrix experimentally. I did this by pressing keys one by one and tracing the corresponding connections with a continuity tester, which helped me understand how the keypad wiring relates to the software input logic.

### Software and C++

- I noticed early on that some parts of C++ felt familiar because of my previous exposure to Python. Concepts such as arrays, variables, constants, loops, conditional logic, and functions gave me a starting point, even though the overall structure and syntax were new to me. I also came across `enum class` definitions for the first time and began to understand their role in representing clearly defined system states.
...
- I also encountered C++ keywords such as `inline`, `constexpr`, and `static` for the first time. While my understanding of them is still only basic, I now have at least a first conceptual idea of the role they can play in code structure and behavior.
...
- Looking back, I know that this project was more ambitious than my original skill level realistically allowed for. I started it without prior experience in C++ or object-oriented programming, so when I began working on the first subsystem in more detail, I quickly realized how much larger the scope was than I had expected.
- At the same time, I am very glad that I still chose to go through with it. Being forced to work on something that was clearly beyond my comfort zone made me adapt quickly and pushed me to learn continuously throughout the project. One of the most rewarding parts for me was seeing self-assembled hardware come to life and interact as a functioning system.
- At this stage, I can understand most parts of the code at least on a functional level, although the depth of that understanding still varies between subsystems. I feel more confident with simpler parts such as the Buzzer Beacon or the Mode Light, and I have a more solid overall understanding of subsystems such as Sensors, Mode Control, and parts of the actuator logic. Other parts, such as keypad handling, RFID integration, and some parts of the LCD logic, remain less intuitive to me and would require further study to fully understand from a software-design perspective.
- One example of a subsystem that I eventually chose to remove was a 4-digit display that was originally intended to show PV voltage continuously. I spent a significant amount of time mapping its pins and segments experimentally, testing it safely with resistors, and distinguishing between common-anode and common-cathode behavior. Although I was eventually able to understand the hardware mapping, I was not satisfied with the display quality and stability in the final setup, especially with regard to flicker. Because this part of the project was consuming a disproportionate amount of time, I decided to remove it from the active build and archive that part of the code instead.
- If I were to approach the project again with my current knowledge, I would probably focus on only two or three subsystems and try to develop them myself with minimal or no AI support, with the goal of understanding them much more deeply from both the implementation and design side. At the same time, I would still choose a project with a broader system context, because working on something larger gave me a much better feel for the complexity, integration effort, and trade-offs involved in projects that are closer to real technical systems.
- Overall, this project confirmed for me that I enjoy learning by doing, especially when hardware, software, and system behavior come together in one prototype. It was a very good complement to the more theoretical learning during the semester, and it also showed me how interested I am in continuing to build my skills in programming, especially in Python and C++.
